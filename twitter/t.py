from tweet_post import (
        initialize, fetch_offset, tweet_destroy,
        tweet_post, tweet_edit, tweet_icon,
        id_to_unix, time_check
)
from consts import (
        CK, CS, AT, AS, id_list, tweet_list
)
import os
...
while True:
    ...
    if(tweet == 'cls'):
        ...
        id_list, tweet_list = tweet_destroy(
            id_list, tweet_list, tweet, twitter)
    elif(tweet[0:4] == 'edit'):
        ...
        id_list, tweet_list = tweet_post(
            id_list, tweet_list, tweet, offset, twitter)
